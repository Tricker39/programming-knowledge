  ...
  <transition name="fade">
    ...
    >
      <div class="he-img-wrap">
        <div class="heimgfont hevue-img-status-icon rotate-animation" v-show="imgState === 1">
          &#xe6b1;
        </div>
        ...
        <div class="he-control-bar-wrap" v-if="controlBar">
          <div class="he-control-bar" @click.stop>
            <!-- 缩小 -->
            <div class="he-control-btn heimgfont" @click.stop="scaleFunc(-0.15)"> &#xe65e; </div>
            <!-- 放大 -->
            <div class="he-control-btn heimgfont" @click.stop="scaleFunc(0.15)"> &#xe65d; </div>
            <!-- 复位 -->
            <div class="he-control-btn heimgfont" v-show="isFull" @click.stop="imgToggle">
              &#xe698;
            </div>
            <!-- 复位 -->
            <div class="he-control-btn heimgfont" v-show="!isFull" @click.stop="imgToggle">
            ...
            <!-- 左转 -->
            <div class="he-control-btn heimgfont" @click.stop="rotateFunc(-90)"> &#xe670; </div>
            <!-- 右转 -->
            <div class="he-control-btn heimgfont" @click.stop="rotateFunc(90)"> &#xe66f; </div>
            <!-- 下载 -->
